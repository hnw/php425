 ...
 * @nodep Gtk
 */
if ('/Users/masato/data/svk/bz2/php_parser/trunk/vendor/pear/php' != '@'.'include_path'.'@') {
    ini_set('include_path', '/Users/masato/data/svk/bz2/php_parser/trunk/vendor/pear/php');
    $raw = false;
} else {
